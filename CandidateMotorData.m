...
MotorName = ['7005']; %For plot legend, all entries need to be of the same length! 
Tm = [1.3];  %Motor cont. torque rating Nm
Tpeak = Tm*5;                %Motor Peak torque rating  Nm 
Jm = [0.1];  %Motor Inertia kgcm^2
Jm=Jm*1e-4; %kgm^2
R = [0.288];         %Motor resistance Ohm
Kt = [60/(115*2*pi)];  %Motor Torque constants. 
